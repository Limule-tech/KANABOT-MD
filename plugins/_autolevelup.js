...
conn.reply(m.chat, [`*「 CONGRATULATIONS LEVEL UP 🆙🥳 」*\n\nCongratulations you leveled up keep it up 👏\n\n*• LEVEL:* ${before} ⟿ ${user.level}\n*• RANK:* ${user.role}\n\n_*To see your XP in real time, type the command #level*_`, `@${m.sender.split`@`[0]} Ohhh senpai you have reached the next level\n*• LEVEL:* ${before} ⟿ ${user.level}\n\n_*To see who is the top, type the command #lb*_`, `What a pro @${m.sender.split`@`[0]} has reached à new level 🙌\n\n*• New level:* ${user.level}\n*• Previous level:* ${before}\n`].getRandom(), m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' 💫 𝐊𝐚𝐧𝐚𝐁𝐨𝐭-𝐌𝐝 𝐀𝐰𝐞𝐬𝐨𝐦𝐞 𝐁𝐨𝐭🥳 ', previewType: 0, thumbnail: img.getRandom(), sourceUrl: redes.getRandom()}}})  
}}		
...
const role = [
      ...
      { name: 'APRENTIS V', level: 20 }, 
      { name: 'APRENTIS IV', level: 24 }, 
      { name: 'APRENTIS III', level: 28 }, 
      { name: 'APRENTIS II', level: 32 }, 
      { name: 'APRENTIS I', level: 36 },
      { name: 'EXPLORADOR(A) V', level: 40 }, 
      { name: 'EXPLORATOR(A) IV', level: 44 }, 
      { name: 'EXPLORATOR(A) III', level: 48 }, 
      { name: 'EXPLORATOR(A) II', level: 52 }, 
      { name: 'EXPLORATOR(A) I', level: 56 },
      ...
      { name: 'Necromancer III', level: 208 }, { name: 'Necromancer II', level: 212 }, { name: 'Necromancer I', level: 216 },
      ...
      { name: 'ÉLITE GLOBAL  V', level: 1060 }, { name: 'ÉLITE GLOBAL  IV', level: 1064 }, { name: 'ÉLITE GLOBAL  III', level: 1068 }, { name: 'ÉLITE GLOBAL  II', level: 1072 }, { name: 'LIMULE TEMPEST  I', level: 1076 },
    ]
